    ...
    <div className="homepage">
        ...
        <Container>
          <Row className='header-box d-flex align-items-center pt-lg-5'>
            <Col lg="6">
              ...
              <p className='mb-4 animate__animated animate__fadeInUp animate__delay-1s'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Sunt aliquam doloribus sed consectetur odio possimus.</p>
      ...
      <div className="kelas w-100 min-vh-100">
        <Container>
          ...
          <Row>
            <Col className='text-center' data-aos="fade-up" data-aos-duration="600">
